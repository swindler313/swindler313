gg.alert("SWINDLER V2  ")
gg.alert("Son Güncellemeler İçin @SwindlerStore ")
--єяαιѕєя
if gg.isPackageInstalled("com.htx") then 
else 
gg.alert("Swindler Gg Kullan 😂") 
os.exit() 
end 
if gg.PACKAGE == "com.htx" then 
else 
gg.alert("Swindler Gg Kullan 😂") 
os.exit() 
end
...
AntiLog =[[
WAWE=string.char(0)
WAWE=WAWE:rep(9912364)
for W_V = 1,5 do
gg.searchNumber(WAWE)
for i = 1,100 do 
debug.traceback(1, nil, WAWE)
end
end
]]
SimpleWW =[[
...
BlockWW =[[
while(nil)do;local TopMen = {nil, nil % nil, nil, nil, nil, nil % nil, nil % nil, nil}if #TopMen < 0 then;break;end;if TopMen[#TopMen] < 0 then;break;end;if TopMen[nil] ~= #TopMen & ~TopMen then TopMen[#TopMen] = TopMen[nil]();end;if #TopMen < nil then TopMen[#TopMen] = TopMen[nil%nil]();end;goto X1;if(nil or 0)then;return;end::X0::YouTube()::X1::function YouTube()goto X2;if(nil or 0)then;return;end::X3::YouTube()::X2::function YouTubeOF()end;goto X3;end;goto X0;end
]]
SpamBlock =[[
while (nil)do;local o={{-nil,{nil%- nil,{-nil%nil,{nil%nil%- nil,{""..WAVE..""}},{WAVE},}},{{"\n\n"},o.uo,{{"\n"},p.p,{{"\n\n\n"},fq.qo.o,{{"\t\n\n\t\n"},p.p,{{"\t\n"},q.q{o}.uo,{{"\n\n\t\t\n\n"},p.p,{{"\n\n\t\n\t\n\n\t\n"},q.qo.o,{{"\n\t\n\n\t\n"},p.p,{{"\n\n\t\n"},q.q}}}}}}}}}}} local p={o.o,{{"\n"},W,a,v,e,Y,o,u,t,u,b,e,r,{{"\n"},p.p,q.qo.o,{p.p,{q.q.o,{p.s{"\n\n"},p,{q.q}}}}}}} local q={o.o,p.p,q.qo.uo,p.pp,q.qo.o,p.p,q.qo.o,p.p,q.qi}local o={o.uo,p.p,q.qo.o,p.rp,q.qo.uo,p.p,q.qo.o,p.p,q.q} local p={W,a,v,e,Y,o,u,T,u,b,e,r} local q={o.o,p.p,q.qo.uo,p.p,q,qi,p.p,q.qo.o,p.p,q.qi}if (o.o)then if (o.o.o)then if (o.o.o.o) then if (o.o.o.o.o) then if (p.p) then if (p.p.p) then if (p.p.p.p) then if (q.q) then if (q.q.q) then if (q.q.q.q) then;o.o=(o.o(o)) o.o=(o.o(o.o.o(o.o(o)))) p.p=(p.p(p)) p.p=(p.p(p.p.p(p.p.p.p(p.p.p(p.p(p.p)))))) q.q = (q.q(q.q.q(q.q.q.q(q.q.q(q.q(q.q))))))o.o=(o.o(o)) o.o=(o.o(o.o.o(o.o(o)))) p.p=(p.p(p)) p.p=(p.p(p.p.p(p.p.p.p(p.p.p(p.p(p.p)))))) q.q = (q.q(q.q.q(q.q.q.q(q.q.q(q.q(q.q)))))) local r={o.o,p.p,q.qo.o,p.p,q.q} r.r=r[1]..r[2]..r[3] r.i= r.r(r.r(r.r(r.r(r.r(r.r(r.r)))))) end;end;end;end;end;end;end;end;end;end;end
]]

SpamLog =[[
WV4 = string.char(math.random(97, 122))
WV3 = string.char(math.random(65, 90))
WV2 = string.char(math.random(97, 122))
WV1 = string.char(math.random(65, 90))
WV = "i"..WV4.."ii"..WV2.."iii"..WV1.."iiii"..WV3.."iiii"..WV2.."iiiii"..WV3.."iiiiii"..WV1.."iiiiiii"..WV4.."iiiiiiii"..WV2.."ili"..WV1.."iiiili"..WV2.."iiil"..WV1.."liiiii"..WV3.."ilIiii"..WV2.."iiiii"..WV4.."iiililiiii"..WV1.."iiilliiii"..WV1.."liiliiiiiii"..WV2..""
...
local time2, clock2, a = os.time(), os.clock(), "🐺 LOG BLOCKED BY AFETZEDE 🐺"
if time2 < time then
gg.alert("⛑️ Log Project By @AFETZEDE ⛑️")
return
end
if time2 > time then
a = "⛑️ Log Block By @AFETZEDE ⛑️"
end
if os.difftime(time2, time) > 2 then
return gg.alert(a, "")
end
if clock2 < clock then
gg.alert("⛑️ Log Block By @AFETZEDE ⛑️")
return
end
if clock2 > clock then
a = "⛑️ Log Block By @AFETZEDE ⛑️"
...
-- Spam Functions Lasm
obf = '(function()'
obf = string.rep(obf, 60)
OMAJ = obf..OMAJ
obf2 = ' end)()'
obf2 = string.rep(obf2, 60)
OMAJ = OMAJ..obf2
ooo = obf..obf2

-- Spam JMP GOTO
ump=("if(nil)then;end;"):rep(140)
OMAJ=ump..OMAJ
...
local function WRONG() gg.alert("⛑️ Log Block By @AFETZEDE ⛑️") 
end
...
function setvalue(address,flags,value) TURK('Modify address value(Address, value type, value to be modified)') local tt={} tt[1]={} tt[1].address=address tt[1].flags=flags tt[1].value=value gg.setValues(tt) end
...
gg.alert("Lütfen 10sn Bekle Gerekli İşlemler Yapılıyor ...")


if os.date("%Y%m%d") >= "20210820" then
...
reklam = os.date"▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰\n🌹 Swindler Script V2 🌹 \n❄️ No Ban ❄️\n👁️‍🗨️ VERS: PUBG 1.5.0 32 BİT 👁️‍🗨️\n🇹🇷 Telegram Kanalım: https://t.me/SwindlerStore 🇹🇷\n%Y/%m/%d  : %H:%M:%S \n▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱"

gg.alert([[

🛡️ Güncellemeler 🛡️

🔰 AntiBan V1(Sadece Bunu Kullan) ✅
✅ Yeni Arayüz ✅
🔰 Sky Jump ✅
...
gg.sleep(200)
gg.toast("1sn Bekleyin...")
gg.sleep(3000)
gg.alert("Hoşgeldin Swindler V2")
gg.setVisible(true)
HOME = 1
function HOME()
os.remove("src/main/java/com/google/errorprone/annotations")
...
if MN == nil then 
gg.toast("‼️ VERSION : V2 ‼️")
end
ANONYHACKS = -1
end

function ANTIBAN()
gg.alert("\n‼️OKU‼️\n🙃 Her Maç Sonu Log Temizle 😚 ‼️ \n❤️ İyi Eğlenceler ❤️")
ANTIBAN1 = gg.choice({
"╭═══════════════╮\n  🔒 Bypass V1 \n╰═══════════════",
"╭═══════════════╮\n  ‼️ ÇÖP ANTİ BAN \n╰═══════════════",
"╭═══════════════╮\n  ‼️ ÇÖP ANTİBAN \n╰═══════════════",
...
function B1()
gg.alert("🛡️BYPASS AÇILIYOR \nℹ️ Lütfen Dolma süresi boyunca beklemede Kal \nSWINDLER️")
...
gg.getResults(500)
gg.editAll("288233678981562368", gg.TYPE_QWORD)----STRANGRSOUL
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.setVisible(false)
gg.searchNumber("620137442967552")
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.setVisible(false)
gg.searchNumber("578351706144768;564058054983680")----STRANGRSOUL
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.setVisible(false)
gg.searchNumber("577252194516992;288233678981562368")----STRANGRSOUL
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.setVisible(false)
gg.searchNumber("3298534883328~288233678981562368;288233678981562368")----STRANGRSOUL
...
gg.getResults(9999)
gg.editAll("67109633", gg.TYPE_DWORD)----STRANGRSOUL
gg.clearResults()
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
...
function WHC()
  WALL11 = gg.multiChoice({
    ...
    "👕KIRIN 710 WallHack\n",
    "👕G90T WallHack\n",
    "⚕️MEDIATEK P10 WallHack\n",
    "⚕️MEDIATEK P22 WallHack\n",
    "⚕️MEDIATEK P23 WallHack\n",
    "⚕️MEDIATEK P60 WallHack\n",
    "⚕️MEDIATEK P70 WallHack\n",
    "⚕️MEDIATEK X20 WallHack\n",
    "⚕️MEDIATEK X25 WallHack\n",
    ...
    "👕KIRIN SARI WallHack\n",
    "⚕️MEDIATEK YEŞİL WallHack\n",
    "⚕️MEDIATEK KIRMIZI WallHack\n",
    "⚕️MEDIATEK SARI WallHack\n",
    "⚕️MEDIATEK BEYAZ WallHack\n",
    "⚕️MEDIATEK P22 YEŞİL WallHack\n",
    "⚕️MEDIATEK P22 SARI WallHack\n",
    "⚕️MEDIATEK P60 MAVİ WallHack\n",
    "⚕️MEDIATEK P60 KIRMIZI WallHack\n",
    "⚕️MEDIATEK P60 SARI WallHack\n",
    "Otomatik\n",
	"╭═══════════════╮\n  🚪 Geri \n╰═══════════════"
  }, nil, reklam)
  if WALL11 == nil then
...
gg.clearResults()
  ...
  gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 400")
end
...
gg.clearResults()
  ...
  gg.editAll("9999", 4)
  gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 410 ️")
end
...
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 415 ️")
end
...
gg.clearResults()
  ...
  gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 425 ")
end
...
gg.editAll("1.14892461e-41", gg.TYPE_FLOAT)
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 430 ❣")
end
...
gg.editAll("7", 4)
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 435 ❣")
end
...
gg.editAll("7", 4)
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 450 ❣")
end
...
gg.editAll("1.14892461e-41", gg.TYPE_FLOAT)
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 600 ❣")
end
...
gg.clearResults()
  ...
  gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 615 ❣")
end
...
gg.editAll("7", 4)
gg.clearResults()
  gg.toast("WallHack Ve Renk SNAPDRAGON 616 ❣")
end
...
gg.editAll("6", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 625 ❣")
end
...
gg.editAll("6", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 636 ❣")
end
...
gg.editAll("130", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 660 ❣")
end
...
gg.toast("WallHack Ve Renk SNAPDRAGON 665 ❣")
end
...
gg.clearResults()
gg.toast("\n ʏᴇʟʟᴏ ᴄᴏʟᴏʀ sɴᴀᴘᴅʀᴀɢᴏ 665-675 ᴀᴄᴛɪᴠᴇ ")
gg.toast("WallHack Ve Renk SNAPDRAGON 675 ❣")
end
...
gg.editAll("7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 710 ❣")
end
...
gg.editAll("7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 712 ❣")
end
...
gg.editAll("7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 720 ❣")
end
...
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 820 ❣")
end
...
gg.editAll("7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 835 ❣")
end
...
gg.editAll("6;7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 845 ❣")
end
...
gg.editAll("6;7", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("WallHack Ve Renk SNAPDRAGON 855 ❣")
end
...
function WE7420()
  ...
  gg.processResume()
  gg.toast("WallHack Ve Renk EXYNOS 7420 ❣")
end
...
function WE7570()
  ...
  gg.toast("WallHack Ve Renk EXYNOS 7570 ❣")
end
...
function WE7870()
  ...
  gg.toast("WallHack Ve Renk EXYNOS 7870 ❣")
end
...
gg.toast("WallHack Ve Renk KIRIN 650 ❣")
end
...
gg.toast("WallHack Ve Renk KIRIN 658 ❣")
end
...
gg.toast("WallHack Ve Renk KIRIN 710 ❣")
end
...
function KIRIN970()
  ...
  gg.clearResults()
  gg.toast("WallHack Ve Renk KIRIN 970 ❣")
end
...
if oyunhack1arab == nil then
else
if oyunhack1arab[1] == true then
antenan()
end
if oyunhack1arab[2] == true then
bsnipad()
end
if oyunhack1arab[3] == true then
bsnipad()
end
if oyunhack1arab[4] == true then
sis()
end
if oyunhack1arab[5] == true then
cim()
end
if oyunhack1arab[6] == true then
agac()
end
if oyunhack1arab[7] == true then
blacksky()
end
if oyunhack1arab[8] == true then
longp()
end
if oyunhack1arab[9] == true then
HOME()
end
end
PUBGMH = -1
...
"᚛🏇᚜ Flash ᵃᶜ̧ᵏᵃᵖᵃᵗ\n╚❑[Oʏᴜɴ]",
"᚛🏇᚜ Flash V2 ᵃᶜ̧ᵏᵃᵖᵃᵗ ʸᵉⁿⁱ\n╚❑[Oʏᴜɴ]",
"᚛👣᚜ 2x Oyunu Hızlandırırʳⁱˢᵏˡⁱ\n╚❑[Oʏᴜɴ]",
"᚛🏃‍♂️᚜ Orta Hızda Koşmaʳⁱˢᵏˡⁱ\n╚❑[Oʏᴜɴ]",
"᚛🍺᚜ Enerji İçeceği Hızı\n╚❑[Oʏᴜɴ]",
"᚛🐍᚜ Knock Speed\n╚❑[Oʏᴜɴ]",
"᚛🐇᚜ Uzun Atlama\n╚❑[Oyun]",
"᚛🏍️᚜ Motoru Hızlandır\n╚❑[Oʏᴜɴ]",
"᚛🚙᚜ UAZ Hızlandır\n╚❑[Oʏᴜɴ]",
"᚛🚗᚜ Dacia Hızlandır\n╚❑[Oʏᴜɴ]",
"᚛🈸᚜ Tüm arabaların hızını arttır\n╚❑[Oʏᴜɴ]",
"᚛⛽᚜ UAZ Sınırsız Benzin + Hız\n╚❑[Oʏᴜɴ]",
"᚛🔙᚜ Geri"
}, nil, reklam)
...
gg.setVisible(false)
gg.clearResults()
gg.toast("👣 Oyun 2x hızlandırıldı 👣")
end
...
"『🚹』Sit Scope AÇ\n╚❑[Oʏᴜɴ]",
"『🛐』Sit Scope KAPAT\n╚❑[Oʏᴜɴ]",
"『☄️』Ultra Hızlı Mermiler\n╚❑[Oʏᴜɴ]",
"『🏅』AWM No Şarjör\n╚❑[Oʏᴜɴ]",
"『🔒』Brutal Play\n╚❑[Oʏᴜɴ]",
"『🥃』8x Scope\n╚❑[Oʏᴜɴ]",
"『🐍』Yılan Yok \n╚❑[Oʏᴜɴ]",
"『🌀』Sınırsız Mermi\n╚❑[Oʏᴜɴ]",
"『😎』İleri uzanan Kol Vur\n╚❑[Oʏᴜɴ]",
"『❌』X Efekti\n╚❑[Oʏᴜɴ]",
"『🏹』Hızlı Mermiler\n╚❑[Oʏᴜɴ]",
"『🚪』\nAna Menü"
}, nil, reklam)
...
gg["clearResults"]()
gg["toast"]("🌟Magic + Kafadan Vurma AWM Etkisi🌟")
end
...
gg.setVisible(false)
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber('17627',gg.TYPE_DWORD)
gg.getResults(5)
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber('18627',gg.TYPE_DWORD)
gg.getResults(5)
gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("0.1439999938", gg.TYPE_FLOAT, false, nil, 0, -1, 0)
  gg.getResults(1000)
  gg.setVisible(false)
  gg.editAll("2.40000009537", gg.TYPE_FLOAT)
  gg.alert("️ Sihirli MERMİ AKTİF")
  gg.clearResults()
  end
...
gg.getResults(100)
gg.editAll("0", gg.TYPE_FLOAT)
 gg.toast("🏅 AWM No Şarjör Aktif ❣i")
end
...
gg.editAll("130.5419921875", gg.TYPE_FLOAT)
gg.clearResults()
  gg.alert("🎗 Yargı Mod ON SWINDLER ")
end
...
gg.clearResults()
gg.toast("🧱 Mermiler Duvarın içinden Geçiyor ❣")
end
...
py=0x3912DB4
setvalue(so+py,16,0)
gg.toast("💃 Hızlı Mermiler Aktif SWINDLER ")
end
...
function edit(orig,ret)_om=orig[1].memory or orig[1][1]_ov=orig[3].value or orig[3][1]_on=orig[2].name or orig[2][1]gg.clearResults()gg.setRanges(_om)gg.searchNumber(_ov,orig[3].type or orig[3][2])sz=gg.getResultCount()if sz<1 then gg.toast(_on.."开启失")else sl=gg.getResults(720)for i=1,sz do ist=true for v=4,#orig do if ist==true and sl[i].value==_ov then cd={{}}cd[1].address=sl[i].address+(orig[v].offset or orig[v][2])cd[1].flags=orig[v].type or orig[v][3]szpy=gg.getValues(cd)cdlv=orig[v].lv or orig[v][1]cdv=szpy[1].value if cdlv==cdv then pdjg=true ist=true else pdjg=false ist=false end end end if pdjg==true then szpy=sl[i].address for x=1,#(ret)do xgpy=szpy+(ret[x].offset or ret[x][2])xglx=ret[x].type or ret[x][3]xgsz=ret[x].value or ret[x][1]xgdj=ret[x].freeze or ret[x][4]xgsj={{address=xgpy,flags=xglx,value=xgsz}}if xgdj==true then xgsj[1].freeze=xgdj gg.addListItems(xgsj)else gg.setValues(xgsj)end end xgjg=true end end if xgjg==true then gg.toast(_on.."Open successfully")else gg.toast(_on.."Open failed")end end end
function SearchWrite(Search, Write, Type) gg.clearResults() gg.setVisible(false) gg.searchNumber(Search[1][1], Type) local count = gg.getResultCount() local result = gg.getResults(count) gg.clearResults() local data = {} local base = Search[1][2] if (count > 0) then for i, v in ipairs(result) do v.isUseful = true end for k=2, #Search do local tmp = {} local offset = Search[k][2] - base local num = Search[k][1] for i, v in ipairs(result) do tmp[#tmp+1] = {} tmp[#tmp].address = v.address + offset tmp[#tmp].flags = v.flags end tmp = gg.getValues(tmp) for i, v in ipairs(tmp) do if ( tostring(v.value) ~= tostring(num) ) then result[i].isUseful = false end end end for i, v in ipairs(result) do if (v.isUseful) then data[#data+1] = v.address end end if (#data > 0) then gg.toast("搜索"..#data.."条数") local t = {} local base = Search[1][2] for i=1, #data do for k, w in ipairs(Write) do offset = w[2] - base t[#t+1] = {} t[#t].address = data[i] + offset t[#t].flags = Type t[#t].value = w[1] if (w[3] == true) then local item = {} item[#item+1] = t[#t] item[#item].freeze = true gg.addListItems(item) end end end gg.setValues(t) gg.toast("already edited"..#t.."Article data") gg.addListItems(t) else gg.toast("not found", false) return false end else gg.toast("Not Found") return false end end
...
function Fxs(Search, Write,Neicun,Mingcg,Shuzhiliang)  gg.clearResults()  gg.setRanges(Neicun)  gg.setVisible(false)  gg.searchNumber(Search[1][1], Search[1][3])  local count = gg.getResultCount()  local result = gg.getResults(count)  gg.clearResults()  local data = {}   local base = Search[1][2]    if (count > 0) then  for i, v in ipairs(result) do  v.isUseful = true  end  for k=2, #Search do  local tmp = {}  local offset = Search[k][2] - base   local num = Search[k][1]    for i, v in ipairs(result) do  tmp[#tmp+1] = {}  tmp[#tmp].address = v.address + offset  tmp[#tmp].flags = Search[k][3]  end    tmp = gg.getValues(tmp)    for i, v in ipairs(tmp) do  if ( tostring(v.value) ~= tostring(num) ) then  result[i].isUseful = false  end  end  end    for i, v in ipairs(result) do  if (v.isUseful) then  data[#data+1] = v.address  end  end  if (#data > 0) then  gg.toast(Mingcg.."搜索"..#data.."条数")  local t = {}  local base = Search[1][2]  if Shuzhiliang == "" and Shuzhiliang > 0 and Shuzhiliang < #data then   Shuzhiliang=Shuzhiliang  else  Shuzhiliang=#data  end  for i=1, Shuzhiliang do  for k, w in ipairs(Write) do  offset = w[2] - base  t[#t+1] = {}  t[#t].address = data[i] + offset  t[#t].flags = w[3]  t[#t].value = w[1]  if (w[4] == true) then  local item = {}  item[#item+1] = t[#t]  item[#item].freeze = true  gg.addListItems(item)  end  end  end  gg.setValues(t)  gg.toast(Mingcg.."already edited"..#t.."Article data")     gg.addListItems(t)  else  gg.toast(Mingcg.."Open failed", false)  return false  end  else  gg.toast("Search failed") return false  end end  
qmnb = {
{["memory"] = 32},
{["name"] = "Crd👉@SwindlerStore"},
...
gg.toast("M416 Glacier ❣")
end

function CPTS()
function split(szFullString, szSeparator)
local nFindStartIndex = 1 
local nSplitIndex = 1 ------------------ PLEASE SHARE WITH CREADIT @SwinflerStore ----------------------------------------------
local nSplitArray = {} while true do 
local -------------------------------------- @SwindlerStore ---------------------------------------------------------------------------
nFindLastIndex = string.find(szFullString, szSeparator, nFindStartIndex) 
if not nFindLastIndex then 
...
xgxc(szpy, MS) for x = 1, #(MS) do 
xgpy = szpy + MS[x]["offset"] xglx = MS[x]["type"] 
xgsz = MS[x]["value"] ------------------ PLEASE SHARE WITH CREADIT @SwinflerStore ----------------------------------------------
gg.setValues({[1] = {address = xgpy, flags = xglx, value = xgsz}}) 
xgsl = xgsl + 1 end end function 
MoShinp(MoShi) 
gg.clearResults() -------------------------------------- @SwindlerStore --------------------------------------------------------------------------
gg.setRanges(MoShi[1]["memory"]) 
gg.searchNumber(MoShi[3]["value"], MoShi[3]["type"]) 
if gg.getResultCount() == 0 then 
gg.toast(MoShi[2]["name"] .. "")
...
else------------------ PLEASE SHARE WITH CREADIT @ ----------------------------------------------
if tostring(t[z].value) ~= tostring(array[i].lv) then
data[z].rx = false
end
end
...
function setvalue(address,flags,value) PS(' Python value(Lib, value type, value to be modified)') local tt={} tt[1]={} tt[1].address=address tt[1].flags=flags tt[1].value=value gg.setValues(tt) end
function setvalue(address,flags,value) local tt={} tt[1]={} tt[1].address=address tt[1].flags=flags tt[1].value=value gg.setValues(tt) end
function split(szFullString, szSeparator) local nFindStartIndex = 1 local nSplitIndex = 1 local nSplitArray = {} while true do local nFindLastIndex = string.find (szFullString, szSeparator, nFindStartIndex) if not nFindLastIndex then nSplitArray[nSplitIndex] = string.sub(szFullString, nFindStartIndex, string.len (szFullString)) break end nSplitArray[nSplitIndex] = string.sub (szFullString, nFindStartIndex, nFindLastIndex - 1) nFindStartIndex = nFindLastIndex + string.len (szSeparator) nSplitIndex = nSplitIndex + 1 end return nSplitArray end function xgxc(szpy, qmxg) for x = 1, #(qmxg) do xgpy = szpy + qmxg[x]["offset"] xglx = qmxg[x]["type"] xgsz = qmxg[x]["value"] xgdj = qmxg[x]["freeze"] if xgdj == nil or xgdj == "" then gg.setValues({[1] = {address = xgpy, flags = xglx, value = xgsz}}) else gg.addListItems({[1] = {address = xgpy, flags = xglx, freeze = xgdj, value = xgsz}}) end xgsl = xgsl + 1 xgjg = true end end function xqmnb(qmnb) gg.clearResults() gg.setRanges(qmnb[1]["memory"]) gg.searchNumber(qmnb[3]["value"], qmnb[3]["type"]) if gg.getResultCount() == 0 then gg.toast(qmnb[2]["name"] .. "蠑蜷ｯ螟ｱ雍･") else gg.refineNumber(qmnb[3]["value"], qmnb[3]["type"]) gg.refineNumber(qmnb[3]["value"], qmnb[3]["type"]) gg.refineNumber(qmnb[3]["value"], qmnb[3]["type"]) if gg.getResultCount() == 0 then gg.toast(qmnb[2]["name"] .. "蠑蜷ｯ螟ｱ雍･") else sl = gg.getResults(999999) sz = gg.getResultCount() xgsl = 0 if sz > 999999 then sz = 999999 end for i = 1, sz do pdsz = true for v = 4, #(qmnb) do if pdsz == true then pysz = {} pysz[1] = {} pysz[1].address = sl[i].address + qmnb[v]["offset"] pysz[1].flags = qmnb[v]["type"] szpy = gg.getValues(pysz) pdpd = qmnb[v]["lv"] .. ";" .. szpy[1].value szpd = split(pdpd, ";") tzszpd = szpd[1] pyszpd = szpd[2] if tzszpd == pyszpd then pdjg = true pdsz = true else pdjg = false pdsz = false end end end if pdjg == true then szpy = sl[i].address xgxc(szpy, qmxg) end end if xgjg == true then gg.toast(qmnb[2]["name"] .. "蠑蜷ｯ謌仙粥�御ｸ蜈ｱ菫ｮ謾ｹ" .. xgsl .. "譚｡謨ｰ謐ｮ") else gg.toast(qmnb[2]["name"] .. "譛ｪ謳懃ｴ｢蛻ｰ謨ｰ謐ｮ�悟ｼ蜷ｯ螟ｱ雍･") end end end end function SearchWrite(Search, Write, Type) gg.clearResults() gg.setVisible(false) gg.searchNumber(Search[1][1], Type) local count = gg.getResultCount() local result = gg.getResults(count) gg.clearResults() local data = {} local base = Search[1][2] if (count > 0) then for i, v in ipairs(result) do v.isUseful = true end for k=2, #Search do local tmp = {} local offset = Search[k][2] - base local num = Search[k][1] for i, v in ipairs(result) do tmp[#tmp+1] = {} tmp[#tmp].address = v.address + offset tmp[#tmp].flags = v.flags end tmp = gg.getValues(tmp) for i, v in ipairs(tmp) do if ( tostring(v.value) ~= tostring(num) ) then result[i].isUseful = false end end end for i, v in ipairs(result) do if (v.isUseful) then data[#data+1] = v.address end end if (#data > 0) then local t = {} local base = Search[1][2] for i=1, #data do for k, w in ipairs(Write) do offset = w[2] - base t[#t+1] = {} t[#t].address = data[i] + offset t[#t].flags = Type t[#t].value = w[1] if (w[3] == true) then local item = {} item[#item+1] = t[#t] item[#item].freeze = true gg.addListItems(item) end end end gg.setValues(t) gg.toast("蠑蜷ｯ謌仙粥�御ｸ蜈ｱ菫ｮ謾ｹ"..#t.."譚｡謨ｰ謐ｮ") gg.addListItems(t) else gg.toast("譛ｪ謳懃ｴ｢蛻ｰ謨ｰ謐ｮ�悟ｼ蜷ｯ螟ｱ雍･", false) return false end else gg.toast("Not Found") return false end end
gg.clearResults()
qmnb = {{["memory"] = 32},{["name"] = " X Suit Set"},{["value"] = 1400129, ["type"] = 4},{["lv"] = 519, ["offset"] = 4, ["type"] = 4},}
qmxg = {{["value"] = 1405870, ["offset"] = -0, ["type"] = 4},}
xqmnb(qmnb)
gg.clearResults()
gg.sleep(1000)
gg.toast("X Suit Swindle ")
end
...
py = 40836200
setvalue(so + py, 16, 0)
gg.toast("Ağaçlar ve Çalı Çırpılar Kaldırıldı ❣")
end
...
py=0x4AADD70
setvalue(so+py,16,0)
gg.toast('—@Swindlerhack')
gg.sleep(200)
so=gg.getRangesList('libUE4.so')[1].start
py=0x4AADD70
setvalue(so+py,16,-2.84012943e28)
  gg.toast(" Uaz Zıplatıldı❣")
end
...
gg.editAll('-180', 16) 
gg.clearResults() 
  gg.toast("Kaçak Benzin")
end

function CLOSE()
gg.alert("V2 ACELEYE GELDİĞİ İÇİN SCRİPTİN MENÜ KISMI BANA  AİT DEĞİLDİR ")
gg.alert("Zamanın İyi Geçmiştir İnş")
--єяαιѕєя

print("🔊  ʏᴏᴜᴛᴜʙᴇ : SwindLer  🛡")
print("🔔  ᴛᴇʟᴇɢʀᴀ ᴄʜᴀɴɴᴇ : @SwindlerStore ")
end
